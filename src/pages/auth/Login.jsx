    ...
    <div className="min-h-screen flex bg-surface-50 dark:bg-surface-950">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-slide-up">
          ...
          <p className="text-surface-500 mb-8">Enter your credentials to access your dashboard</p>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary-500 via-purple-500 to-accent-500 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute w-48 h-48 bg-white/10 rounded-full bottom-20 left-20 animate-float" style={{ animationDelay: '2s' }}></div>
          <div className="absolute w-36 h-36 bg-white/10 rounded-full top-40 left-32 animate-float" style={{ animationDelay: '4s' }}></div>
        </div>
        <div className="text-center text-white relative z-10 px-12">
          ...
          <h2 className="text-4xl font-extrabold mb-4">Power Up Your Business</h2>
          <p className="text-white/80 max-w-sm mx-auto">
            AI-powered tools to create, manage, and grow your local business online.
          </p>
        </div>
      </div>
    </div>
