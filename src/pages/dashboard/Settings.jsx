...
const Settings = () => {
  ...
  if (loading)
    return (
      <div className="h-96 rounded-2xl bg-surface-200 dark:bg-surface-800 animate-pulse" />
    );
    ...
    <div className="space-y-6 animate-fade-in max-w-3xl">
      ...
      <div className="glass-card p-6 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => update("settings.currency", e.target.value)}
              className="input-field"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                update("settings.taxRate", Number(e.target.value))
              }
              className="input-field"
            />
          </div>
          <div>
            ...
            <input
              type="number"
              value={business?.settings?.shippingFee || 0}
              onChange={(e) =>
                update("settings.shippingFee", Number(e.target.value))
              }
              className="input-field"
            />
          </div>
        ...
        <div className="flex gap-6">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              checked={business?.settings?.enableChat}
              onChange={(e) => update("settings.enableChat", e.target.checked)}
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              checked={business?.settings?.enableOrders}
              onChange={(e) =>
                update("settings.enableOrders", e.target.checked)
              }
              className="w-4 h-4 accent-primary-500"
            />
      ...
      <div className="glass-card p-6 space-y-3">
        ...
        <p className="text-sm text-surface-500">
          See how your color and design choices look together before saving.
        </p>
        <ThemePreview
          themeConfig={business?.theme}
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-surface-500 mt-1">
              Pick a color palette for your storefront. Design layout is
              customized separately below.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="pt-2 border-t border-surface-100 dark:border-surface-800">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                type="color"
                value={business?.theme?.primaryColor || "#6366f1"}
            ...
            <div>
              ...
              <input
                type="color"
                value={business?.theme?.secondaryColor || "#8b5cf6"}
            ...
            <div>
              ...
              <input
                type="color"
                value={business?.theme?.accentColor || "#06b6d4"}
      ...
      <div className="glass-card p-6 space-y-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-surface-500 mt-1">
              Customize the layout and structure of your storefront
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <div>
              ...
              <p className="text-xs text-surface-500">
                Use a dark background across your entire store
              </p>
            </div>
          </label>
        </div>
