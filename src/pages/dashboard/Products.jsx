    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <label
            className={`btn-outline flex items-center gap-2 cursor-pointer ${bulkLoading ? "opacity-50 pointer-events-none" : ""}`}
          >
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="h-64 rounded-2xl bg-surface-200 dark:bg-surface-800 animate-pulse"
            />
          ))}
        </div>
      ) : products.length === 0 ? (
              ...
              <div className="relative aspect-square bg-surface-100 dark:bg-surface-800">
                ...
                <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-2 rounded-lg bg-white/90 dark:bg-surface-800/90 shadow hover:bg-primary-500 hover:text-white transition-colors"
                  >
                    <Edit2 className="w-3.5 h-3.5" />
                  </button>
                  <button
                    onClick={() => toggleActive(product)}
                    className="p-2 rounded-lg bg-white/90 dark:bg-surface-800/90 shadow hover:bg-amber-500 hover:text-white transition-colors"
                  >
                    {product.isActive ? (
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-white/90 dark:bg-surface-800/90 shadow hover:bg-red-500 hover:text-white transition-colors"
                  >
