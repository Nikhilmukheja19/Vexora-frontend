      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            {product.images?.map((img, i) => (
              <div
                key={i}
                className="w-24 h-24 glass-card overflow-hidden cursor-pointer ring-primary-500 ring-offset-2"
              >
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-extrabold text-surface-900 dark:text-white">
              {product.name}
            </h1>
